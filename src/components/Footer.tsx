    ...
    <footer className="relative border-t border-white/10 bg-ink-950">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="flex flex-wrap items-end justify-between gap-10">
          <a href="#top" className="flex items-center gap-3 font-display text-2xl font-bold tracking-tight text-white">
            <Mark className="h-7 w-7 text-flame" />
            Nexus<span className="text-white/40">Collective</span>
          </a>

          <div className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-xs text-white/40">
            {developers.map(
              (d) =>
                d.links.github && (
                  <a
